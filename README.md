...
This repository consists of several crates that can be specified as git dependencies in your `Cargo.toml` file. It is recommended that you use either `tag` or `rev` to specify a version.

```toml
trve_bevy_image   = { git = "https://github.com/TrveSoft/trve_bevy.git", tag = "trve_bevy_image-v0.1.0" }
trve_bevy_font = { git = "https://github.com/TrveSoft/trve_bevy.git", tag = "trve_bevy_font-v0.1.0" }
```
